...
- `clients/web/` — React 19 + Vite + TypeScript веб-клиент; **Phase 8 UI/UX:** полностью кастомный CSS design system (tokens.css + app.css), шрифт Inter Tight, кастомный Icon компонент (40+ SVG), Sidebar/Topbar/Inspector, 5 основных страниц, Toast bus; **AntD полностью удалён**; 10 Vitest тестов; ErrorPage + ErrorBoundary (2026-05-11)
...
- **185 .NET тестов + 22 Desktop-тестов + 10 Vitest тестов — все зелёные**
